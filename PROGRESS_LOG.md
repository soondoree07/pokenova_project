...
마지막 업데이트: 2026-03-24 (포켓몬 도감 페이지 + 레전드ZA 메가 추가 + 데이터 정리)
...
| 항목 | 상태 |
|------|------|
| 특성 이름 31개 (ID 268~298) | ⏳ 사용자가 번역 예정 |
| 특성 설명 40개 (ID 268~307) | ⏳ 사용자가 번역 예정 |
| 기술 설명 42개 (Z기술 18 + Gen8-9 24) | ⏳ 미번역 |
| 도구 이름 영어 26개 (메일류 등) | ⏳ 미번역 (퀴즈에서 대부분 제거됨) |
| 도구 설명 영어 ~180개 | ⏳ 미번역 |
| 레전드ZA 메가 특성 26종 | ⏳ 정보 없음 (? 표시) |
